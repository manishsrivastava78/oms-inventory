...
public class CustomErrorHandler  extends ResponseEntityExceptionHandler implements Constants{
	...
	public ResponseEntity<Object> inventoryNotFoundException(Exception ex, WebRequest request) throws Exception {
		return getResponseEntity(request,HttpStatus.NOT_FOUND,ex,null);
	}
	
	@ExceptionHandler(InventoryException.class)
	public ResponseEntity<Object> inventoryNotFoundException1(Exception ex, WebRequest request) throws Exception {
		return getResponseEntity(request,HttpStatus.BAD_REQUEST,ex,null);
	}
	
	
	
	@ExceptionHandler(InventoryProductException.class)
	public ResponseEntity<Object> productExistException(Exception ex, WebRequest request) throws Exception {
		return getResponseEntity(request,HttpStatus.BAD_REQUEST,ex,null);
	}
